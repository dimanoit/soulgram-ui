...
@NgModule({
  declarations: [AuthorizationComponent, ForgotPasswordComponent, GeneralInterestsComponent],
  providers: [AuthService, SoulHttpClient, LocalStorageService, InterestsService],
  imports: [
    CommonModule,
    HttpClientModule,
    ReactiveFormsModule,
